...
### 2. Tag Applications
Use [blastoff](https://pypi.org/project/innoday-blastoff/) to tag applications across a GitHub topic: `blastoff release -c <alias>` (dry run) or add `--release` to execute.
